...
void RelayOutput(){
  //funcao para criar uma saida invertida do status de ligado e desligado - Previne o desligamento do circuito quando o esp ficar sem bateria
  digitalWrite(LED_INV_RELAY, !(StatusLED));
}
